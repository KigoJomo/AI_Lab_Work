...
def calculate_total_distance(route, distance_matrix):
    ...
    # Return to starting point (Nairobi)
...
def find_optimal_path(counties, distance_matrix):
    # Start from 1 because 0 is Nairobi
    all_routes = itertools.permutations(range(1, len(counties)))
...
def main():
    ...
    folium.PolyLine(route_coords, color="blue",
